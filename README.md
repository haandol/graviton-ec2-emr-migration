...
5. [Phase 3: Zeppelin 설정 마이그레이션](#5-phase-3-zeppelin-설정-마이그레이션)
6. [Phase 3.5: S3 이관 허브 구성](#6-phase-35-s3-이관-허브-구성)
7. [Phase 4: Graviton 인스턴스 전환 지원](#7-phase-4-graviton-인스턴스-전환-지원)
8. [Phase 5: IaC 템플릿 생성 및 클러스터 프로비저닝](#8-phase-5-iac-템플릿-생성-및-클러스터-프로비저닝)
9. [Phase 5.5: 새 클러스터 데이터/설정 복원](#9-phase-55-새-클러스터-데이터설정-복원)
10. [Phase 5.7: 네트워크 및 데이터 소스 연결 검증](#10-phase-57-네트워크-및-데이터-소스-연결-검증)
11. [Phase 6~7: 테스트·전환 체크리스트 관리](#11-phase-67-테스트전환-체크리스트-관리)
...
## 8. Phase 5: IaC 템플릿 생성 및 클러스터 프로비저닝
...
## 10. Phase 5.7: 네트워크 및 데이터 소스 연결 검증
